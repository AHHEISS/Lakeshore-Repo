...
set "VENV_PATH=C:\Users\User Access\AppData\Local\Programs\Python\Lakeshore_Py\virt\Scripts\activate.bat"

rem Activate the virtual environment
call "%VENV_PATH%"

rem Change directory to where your executable is located
cd C:\Users\User Access\AppData\Local\Programs\Python\Lakeshore_Py
...
start "" /B "dist\LakeshoreApp-E8-Flow-Press.exe"
