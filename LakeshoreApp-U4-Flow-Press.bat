...
set "VENV_PATH=C:\Users\Test Lab2\AppData\Local\Programs\Python\Lakeshore_Py\virt\Scripts\activate.bat"

rem Activate the virtual environment
call "%VENV_PATH%"

rem Change directory to where your executable is located
cd C:\Users\Test Lab2\AppData\Local\Programs\Python\Lakeshore_Py
